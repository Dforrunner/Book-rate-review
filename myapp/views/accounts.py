...
from myapp.ext import login_manager, db
from flask_login import current_user, login_user, logout_user, login_required
from is_safe_url import is_safe_url
# Forms
from myapp.forms.account_forms import SignInForm, SignUpForm, PassResetEmailForm, PassResetForm
# Utils
from myapp.util.token import generate_confirmation_token, confirm_token
from myapp.util.email import send_email
# User model
from myapp.models import User
# Helper functions
from myapp.helpers import redirect_to_profile, redirect_back
import os

account = Blueprint('account', __name__, template_folder='myapp/templates')
...
def confirm_user(token):
    ...
    print(email)
    if current_user.email == email and user.confirmed:
